...
> Use pytest. Minimum 20 tests per function across the 12-category taxonomy (happy / structure / boundaries / empty / type abuse / range / unicode / errors / idempotency / state / time-concurrency / adversarial)...
